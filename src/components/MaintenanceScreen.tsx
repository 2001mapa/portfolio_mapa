  ...
  return (
    <div className="min-h-screen bg-[#020617] text-[#E2E2B6] flex flex-col items-center justify-center relative overflow-hidden px-6">
      ...
      >
        ...
        {/* Botón de Emergencia */}
        <a 
          href="https://wa.me/573214533924?text=Hola%20Miguel,%20el%20portafolio%20está%20en%20mantenimiento%20pero%20me%20gustaría%20hablar%20sobre%20un%20proyecto."
          target="_blank"
