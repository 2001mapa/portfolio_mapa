      ...
      <div ref={heroRef} className="relative w-full min-h-[50vh] overflow-hidden flex items-start pt-32 md:pt-40">
        ...
        >
          <div className="max-w-[1400px] mx-auto w-full relative h-full flex flex-col items-center justify-center pt-16 md:pt-0">
            <Link href="/#work" className="absolute top-0 left-0 md:-top-16 font-[family-name:var(--font-ibm-plex-mono)] text-caption font-semibold tracking-caption uppercase text-[#8971a5] hover:text-[#d6cce5] transition-colors z-50">
              ← REGRESAR AL HUB
            </Link>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col gap-16 md:gap-32 font-[family-name:var(--font-die-grotesk-b)]">
          ...
          <div className="w-full max-w-[800px] mx-auto mt-12 md:mt-12 px-6 md:px-0 text-center flex flex-col items-center">
             ...
             <a 
               ...
               className="inline-flex items-center justify-center border border-[#b039d3] text-[#b039d3] hover:bg-[#b039d3] hover:text-white transition-colors px-6 py-3 rounded-full font-[family-name:var(--font-ibm-plex-mono)] uppercase text-sm tracking-widest font-semibold mb-4 shadow-[0_0_20px_rgba(176,57,211,0.15)] hover:shadow-[0_0_30px_rgba(176,57,211,0.3)]"
             >
          ...
          >
            ...
            <Link 
              href="/#pricing"
              className="mt-4 bg-[#b039d3] text-white font-[family-name:var(--font-ibm-plex-mono)] uppercase tracking-widest px-10 py-5 rounded-full font-bold shadow-[0_0_30px_rgba(176,57,211,0.4)] hover:shadow-[0_0_50px_rgba(176,57,211,0.6)] hover:bg-[#c945f0] transition-all hover:-translate-y-1"
            >
              Cotizar mi Linktree
            </Link>
            ...
            <Link 
              ...
              className="mt-6 font-[family-name:var(--font-ibm-plex-mono)] text-sm tracking-widest text-[#8971a5] hover:text-[#b039d3] transition-colors border-b border-transparent hover:border-[#b039d3] pb-1"
            >
